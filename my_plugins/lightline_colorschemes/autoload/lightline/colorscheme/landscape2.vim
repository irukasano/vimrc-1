...
let s:p.normal.right = [ ['#0000ff', '#ffffff', 21, 231, 'bold' ], [ '#ffffff', '#0000ff', 231, 21 ] ]
let s:p.inactive.right = [ [ '#121212', '#606060', 233, 241 ], [ '#121212', '#3a3a3a', 233, 237 ], [ '#121212', '#262626', 233, 235 ] ]
"let s:p.inactive.left = s:p.inactive.right[1:]
let s:p.inactive.left = [ [ '#303030', '#8a8a8a', 236, 245 ] ]
...
let s:p.visual.left = [ [ '#5f00ff', '#ffffff', 229, 231, 'bold' ], [ '#ffffff', '#5f00ff', 231, 229 ] ]
"let s:p.visual.left = [ [ '#5f00ff', '#ffffff', 57, 231, 'bold' ], [ '#ffffff', '#5f00ff', 231, 57 ] ]
"let s:p.normal.middle = [ [ '#8a8a8a', '#303030', 245, 236 ] ]
let s:p.normal.middle = [ [ '#8a8a8a', '#303030', 231, 21 ] ]
let s:p.insert.middle = [ [ '#8a8a8a', '#303030', 231, 22 ] ]
let s:p.replace.middle = [ [ '#8a8a8a', '#303030', 231, 124 ] ]
let s:p.visual.middle = [ [ '#8a8a8a', '#303030', 231, 229 ] ]
"let s:p.inactive.middle = [ [ '#303030', '#121212', 236, 233 ] ]
let s:p.inactive.middle = [ [ '#303030', '#121212', 236, 252 ] ]
let s:p.tabline.left = [ [ '#d0d0d0', '#666666', 252, 242 ] ]
"let s:p.tabline.tabsel = [ [ '#dadada', '#121212', 253, 233 ] ]
let s:p.tabline.tabsel = [ [ '#dadada', '#121212', 21, 231 ] ]
"let s:p.tabline.middle = [ [ '#8a8a8a', '#3a3a3a', 245, 237 ] ]
let s:p.tabline.middle = [ [ '#8a8a8a', '#3a3a3a', 252, 250 ] ]
...
let g:lightline#colorscheme#landscape2#palette = s:p
